...
%\medskip
        ...
        %\]
        %qui est bien solution de \eqref{eq.par}. Voici un exemple avec $a=2$ et $h(v) = 3\sin\left( - v^2 /10 \right)$:
		%\begin{center}
			%\begin{tikzpicture}[scale=.5]
...
%\medskip
    ...
    \item La fonction $f$ possède-t-elle un maximum global?
        ...
        %C'est une fonction polynomiale et n'est donc pas bornée. Il n'y a pas d'extrema globaux finis.
\end{enumerate}
