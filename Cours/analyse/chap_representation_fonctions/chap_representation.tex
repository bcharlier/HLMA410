\chapter[Représentation]{Réprésentation des fonctions de plusieurs variables}
...
La fonction $f:\R \to \R$ défini par $f(x) = \log(x(x+3)(x-2))$ a pour domaine de définition $\D(f) = ]-3,0[ \cup ]2,+\infty[$ (en rouge sur le graphique) et pour ensemble image $Im(f) =\R$ :
    \begin{center}
        \tikzexternalenable
        \tikzsetnextfilename{coursdomdef}
        \begin{tikzpicture}[scale =1]
            \begin{axis}[axis x line=middle,axis y line=middle,ymin=-6,ymax=6,xmin=-4,xmax=6, after end axis/.code = {\draw[red!50,ultra thick] (axis cs:-3,0) -- (axis cs:0,0);\draw[red!50,ultra thick] (axis cs:2,0) -- (axis cs:6,0);}]				
                \addplot[color=blue,id=excurve1,domain=-2.9999:-0.001,smooth,samples=800, very thick] gnuplot {log(x*(x+3)*(x-2))};				
                \addplot[color=blue,id=excurve2,domain=2.0001:6,smooth,samples=800,very thick] gnuplot {log(x*(x+3)*(x-2))};
            \end{axis}
        \end{tikzpicture}
        \tikzexternaldisable
    \end{center}
...
\begin{exemple} \label{exemple.fpv}
    ...
    \begin{center}
        \begin{minipage}{5cm}
            \input{../figures/domaine_def.tex} 
        \end{minipage}
%				\begin{minipage}{5cm}
%					\input{../figures/plot_fun.tex}	
%				\end{minipage}
    \end{center}
...
\begin{exemple}
    ...
    \begin{center}
        \begin{minipage}{5cm}
            \tikzexternalenable
            \tikzsetnextfilename{coursdomdef2}
            \begin{tikzpicture}
                \def\side{2}
...
\begin{center}
    \input{../figures/representation_3d.tex}
\end{center}
...
\begin{exemple}
    ...
    \begin{center}
        \begin{tabular}{cc}
            \tikzexternalenable\tikzsetnextfilename{coursgraph1}
            \begin{tikzpicture}
            ...
            \tikzexternaldisable	
            &
            \tikzexternalenable\tikzsetnextfilename{coursgraph2}
            \begin{tikzpicture}
                \begin{axis}[xlabel = $x$,ylabel=$y$,zlabel=$z$,every axis z label/.style={ at={(rel axis cs:-0.15,-0.15,0.5)}},width=.45\textwidth,]
        ...
        \begin{tabular}{cc}
            \tikzexternalenable		\tikzsetnextfilename{cours0graph3}
            \begin{tikzpicture}
                \begin{axis}[xlabel = $x$,ylabel=$y$,zlabel=$z$,every axis z label/.style={ at={(rel axis cs:-0.15,-0.15,0.5)}},width=.45\textwidth,]
                    \addplot3[surf,domain=-4:4,samples=50,colormap/cool,opacity=.8] gnuplot {(x**2+y**2)};
                \end{axis}
            \end{tikzpicture}&
            \tikzsetnextfilename{cours-graph4}
            \begin{tikzpicture}
                \begin{axis}[xlabel = $x$,ylabel=$y$,zlabel=$z$,every axis z label/.style={ at={(rel axis cs:-0.15,-0.15,0.5)}},width=.45\textwidth,]
                    \addplot3[surf,domain=-4:4,samples=50,colormap/cool,opacity=.8]gnuplot{(x**2-y**2)};
                \end{axis}
...
\begin{exemple}
 Voici les fonctions du paragraphe précédent. Les couleurs codent l'intensité du signal comme l'indique la présence d'une échelle de couleurs à coté de chaque graphique. 
        \begin{center}
                \begin{tabular}{cc}
                \tikzexternalenable\tikzsetnextfilename{coursgraphcoul1}
                        \begin{tikzpicture}
                        ...
                        \end{tikzpicture}	
                                                \tikzexternaldisable           
&
                \tikzexternalenable\tikzsetnextfilename{coursgraphcoul2}
                        \begin{tikzpicture}
                                \begin{axis}[ylabel style={rotate=-90},xlabel = $x$,ylabel=$y$,width=.4\textwidth,colorbar,colormap/cool,view={0}{90}]
 ...
 \\
        ...
        \tikzexternalenable
                \begin{tabular}{cc}
\tikzsetnextfilename{coursgraphcoul3}
                        \begin{tikzpicture}
                                \begin{axis}[ylabel style={rotate=-90},xlabel = $x$,ylabel=$y$,width=.4\textwidth,colorbar,colormap/cool,view={0}{90}]
                        ...
                        \end{tikzpicture}
&\hspace*{1.45em} 
\tikzsetnextfilename{coursgraphcoul4}
                        \begin{tikzpicture}
                                \begin{axis}[ylabel style={rotate=-90},xlabel = $x$,ylabel=$y$,width=.4\textwidth,colorbar,colormap/cool,view={0}{90}]
...
\begin{tabular}{cc}
    ...
    \begin{tikzpicture}[scale=.7]
        ...
        \end{axis}
    \end{tikzpicture} \\
    Graphe de $f(x,y) = \sin(\sqrt{x^2 + y^2}) /\sqrt{x^2 + y^2}$ & Graphe de $f^2_a:y \mapsto f(a,y)$ où $a = 6$
\end{tabular}
...
\begin{exemple}
    ...
    \begin{center}
        ...
        \input{../figures/vector_field.tex}
        \tikzexternaldisable
    \end{center}
\end{exemple}
...
\begin{exemple}
    ...
    \begin{center}
        ...
        \input{../figures/vector_field_3d.tex}
        \tikzexternaldisable
